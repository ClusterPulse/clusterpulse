...
func (c *collectorServiceClient) Connect(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[ConnectRequest, ConnectResponse], error) {
...
type CollectorService_ConnectClient = grpc.BidiStreamingClient[ConnectRequest, ConnectResponse]
...
func (UnimplementedCollectorServiceServer) Connect(grpc.BidiStreamingServer[ConnectRequest, ConnectResponse]) error {
...
func _CollectorService_Connect_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(CollectorServiceServer).Connect(&grpc.GenericServerStream[ConnectRequest, ConnectResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type CollectorService_ConnectServer = grpc.BidiStreamingServer[ConnectRequest, ConnectResponse]
...
var CollectorService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "clusterpulse/collector/v1/collector.proto",
}
