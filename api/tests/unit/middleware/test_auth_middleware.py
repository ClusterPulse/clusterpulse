...
class TestAuthMiddlewarePublicEndpoints:
    ...
    def test_public_endpoint_allowed_when_enabled(self, app_with_auth_middleware, monkeypatch):
    ...
    def test_public_endpoint_blocked_when_disabled(self, app_with_auth_middleware, monkeypatch):
...
class TestAuthMiddlewareOAuthHeaders:
    ...
    def test_logs_oauth_headers_in_debug_mode(self, app_with_auth_middleware, monkeypatch, caplog):
    ...
    def test_does_not_log_oauth_headers_when_debug_disabled(self, app_with_auth_middleware, monkeypatch, caplog):
...
class TestAuthMiddlewareConfiguration:
    ...
    def test_development_mode_configuration(self, app_with_auth_middleware, monkeypatch):
