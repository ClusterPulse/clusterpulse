...
class TestLoggingMiddlewareRequestLogging:
    ...
    def test_logs_query_params(self, app_with_logging_middleware, caplog):
        ...
        assert any("foo" in record.message and "bar" in record.message for record in log_records)
...
class TestLoggingMiddlewarePerformance:
    ...
    def test_does_not_significantly_impact_fast_requests(self, app_with_logging_middleware):
