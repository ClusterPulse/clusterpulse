...
from src.core.rbac_engine import Action, Principal, Resource, ResourceType
...
@router.get("/clusters/health", summary="Public Cluster Health", description="Get basic cluster health status (no authentication required)")
...
@router.get("/health", summary="Public API Health", description="Check if public API is available")
